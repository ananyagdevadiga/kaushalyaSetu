...
import { Building, Users, Briefcase, Search, ClipboardList } from 'lucide-react';
    ...
    <div className="space-y-12">
      <section className="p-8 bg-gradient-to-r from-primary to-indigo-600 text-primary-foreground rounded-lg shadow-xl">
         <div className="flex flex-col md:flex-row items-center gap-6">
          <Building className="w-16 h-16 text-accent" /> {/* Icon size adjusted */}
          <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent>
            ...
            <Button asChild className="mt-4 w-full bg-accent text-accent-foreground hover:bg-accent/90">
              <Link href="/industry/post-listing">Create Listing</Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          <CardHeader>
             <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-xl font-headline text-primary">View My Listings</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <CardDescription>Review your posted listings and see student applications.</CardDescription>
             <Button asChild variant="link" className="text-primary p-0 mt-4">
              <Link href="/industry/my-listings">Manage Listings &rarr;</Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent>
            <CardDescription>Browse student portfolios and discover candidates. (Coming Soon)</CardDescription>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent>
            <CardDescription>Engage with students through webinars, talks, and mentorship. (Coming Soon)</CardDescription>
            <Button asChild variant="link" className="text-primary p-0 mt-4" disabled>
